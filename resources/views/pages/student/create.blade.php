                    ...
                    <form method="POST" action="/students" class="needs-validation" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="mt-2 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                ...
                                <input type="text" name="age" class="form-control" id="validationCustom02" placeholder="Age" value="{{ old('age') }}">
                                @error('age')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="mt-2 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                ...
                                <label class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" name="gender" class="custom-control-input" value="m" {{ old('gender')=="m" ? "checked" : "" }}><span class="custom-control-label">Male</span>
                                </label>
                                <label class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" name="gender" class="custom-control-input" value="f" {{ old('gender')=="f" ? "checked" : "" }}><span class="custom-control-label">Female</span>
                                </label>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                <label for="validationCustom02">Reporting Teacher</label>
                                    <select name="reporting_teacher" class="form-control" id="input-select">
                                        ...
                                        <option value="{{ $teacher->id }}" {{ old('reporting_teacher') == $teacher->id ? 'selected' : '' }}>{{ $teacher->name }}</option>
                                        @endforeach
                                    </select>
